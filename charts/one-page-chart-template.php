...
class Disciple_Tools_OM_SSO_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-om-sso-metrics'; // lowercase
    public $base_title = "OM SSO Metrics";
    ...
    public function scripts() {
        ...
        wp_localize_script(
            'dt_'.$this->slug.'_script', $this->js_object_name, [
                ...
                'translations' => [
                    "title" => $this->title,
                    "Sample API Call" => __( "Sample API Call", 'disciple-tools-om-sso' )
                ]
            ]
        );
    }
