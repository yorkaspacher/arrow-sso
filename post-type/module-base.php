...
/**
 * Class Disciple_Tools_OM_SSO_Base
 * Load the core post type hooks into the Disciple Tools system
 */
class Disciple_Tools_OM_SSO_Base extends DT_Module_Base {
     ...
     * @var string
     */
    public $post_type = "om_sso";
    public $module = "om_sso_base";
    public $single_name = 'OM SSO';
    public $plural_name = 'OM SSO';
    ...
    public function dt_set_roles_and_permissions( $expected_roles ){
        ...
        if ( !isset( $expected_roles["multiplier"] ) ){
            $expected_roles["multiplier"] = [
                ...
                "label" => __( 'Multiplier', 'disciple-tools-om-sso' ),
    ...
    public function dt_custom_fields_settings( $fields, $post_type ){
        if ( $post_type === $this->post_type ){
             ...
             */
            $fields['status'] = [
                'name'        => __( 'Status', 'disciple-tools-om-sso' ),
                'description' => _x( 'Set the current status.', 'field description', 'disciple-tools-om-sso' ),
                'type'        => 'key_select',
                'default'     => [
                    'inactive' => [
                        'label' => __( 'Inactive', 'disciple-tools-om-sso' ),
                        'description' => _x( 'No longer active.', 'field description', 'disciple-tools-om-sso' ),
                        'color' => "#F43636"
                    ],
                    'active'   => [
                        'label' => __( 'Active', 'disciple-tools-om-sso' ),
                        'description' => _x( 'Is active.', 'field description', 'disciple-tools-om-sso' ),
                        'color' => "#4CAF50"
                    ],
                ],
                'tile'     => 'status',
            ...
            $fields['assigned_to'] = [
                'name'        => __( 'Assigned To', 'disciple-tools-om-sso' ),
                'description' => __( "Select the main person who is responsible for reporting on this record.", 'disciple-tools-om-sso' ),
                'type'        => 'user_select',
                'default'     => '',
                'tile' => 'status',
             ...
             */
            $fields['start_date'] = [
                'name'        => __( 'Start Date', 'disciple-tools-om-sso' ),
                'description' => '',
                'type'        => 'date',
                'default'     => time(),
                'tile' => 'details',
            ...
            $fields['end_date'] = [
                'name'        => __( 'End Date', 'disciple-tools-om-sso' ),
                'description' => '',
                'type'        => 'date',
                'default'     => '',
                'tile' => 'details',
            ...
            $fields['location_grid'] = [
                'name'        => __( 'Locations', 'disciple-tools-om-sso' ),
                'description' => _x( 'The general location where this contact is located.', 'Optional Documentation', 'disciple-tools-om-sso' ),
                'type'        => 'location',
                'mapbox'    => false,
                "in_create_form" => true,
                "tile" => "details",
            ...
            $fields['location_grid_meta'] = [
                'name'        => __( 'Locations', 'disciple-tools-om-sso' ), //system string does not need translation
                'description' => _x( 'The general location where this record is located.', 'Optional Documentation', 'disciple-tools-om-sso' ),
                'type'        => 'location_meta',
                "tile"      => "details",
                'mapbox'    => false,
                'hidden' => true
            ...
            $fields["contact_address"] = [
                "name" => __( 'Address', 'disciple-tools-om-sso' ),
             ...
             */
            $fields["parents"] = [
                "name" => __( 'Parents', 'disciple-tools-om-sso' ),
                'description' => '',
                "type" => "connection",
            ...
            $fields["peers"] = [
                "name" => __( 'Peers', 'disciple-tools-om-sso' ),
                'description' => '',
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "any",
            ...
            $fields["children"] = [
                "name" => __( 'Children', 'disciple-tools-om-sso' ),
                'description' => '',
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "to",
             ...
             */
            $fields["peoplegroups"] = [
                "name" => __( 'People Groups', 'disciple-tools-om-sso' ),
                'description' => _x( 'The people groups connected to this record.', 'Optional Documentation', 'disciple-tools-om-sso' ),
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "to",
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ){
        if ( $post_type === $this->post_type ){
            $tiles["connections"] = [ "label" => __( "Connections", 'disciple-tools-om-sso' ) ];
            $tiles["other"] = [ "label" => __( "Other", 'disciple-tools-om-sso' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_details_additional_section( $section, $post_type ){
        ...
        if ( $post_type === $this->post_type && $section === "other" ) {
            ...
            <div class="section-subheader">
                <?php esc_html_e( "Custom Section Contact", 'disciple-tools-om-sso' ) ?>
            </div>
            <div>
    ...
    public static function dt_user_list_filters( $filters, $post_type ){
        ...
        if ( $post_type === self::post_type() ){
            ...
            $filters["tabs"][] = [
                "key" => "assigned_to_me",
                "label" => _x( "Assigned to me", 'List Filters', 'disciple-tools-om-sso' ),
                "count" => $total_my,
                "order" => 20
            ];
            ...
            $filters["filters"][] = [
                'ID' => 'my_all',
                'tab' => 'assigned_to_me',
                'name' => _x( "All", 'List Filters', 'disciple-tools-om-sso' ),
                'query' => [
                    'assigned_to' => [ 'me' ],
                    'sort' => 'status'
                ],
            ...
            if ( current_user_can( 'view_any_' . self::post_type() ) ){
                ...
                $filters["tabs"][] = [
                    "key" => "all",
                    "label" => _x( "All", 'List Filters', 'disciple-tools-om-sso' ),
                    "count" => $total_all,
                    "order" => 10
                ];
                // add assigned to me filters
