...
class Disciple_Tools_OM_SSO_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === "contacts" || $post_type === "om_sso" ){
            $tiles["disciple_tools_om_sso"] = [ "label" => __( "OM SSO", 'disciple-tools-om-sso' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" || $post_type === "om_sso"){
             ...
             */
            $fields['disciple_tools_om_sso_text'] = [
                'name'        => __( 'Text', 'disciple-tools-om-sso' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-om-sso' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_om_sso',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields["disciple_tools_om_sso_multiselect"] = [
                "name" => __( 'Multiselect', 'disciple-tools-om-sso' ),
                "default" => [
                    "one" => [ "label" => __( "One", 'disciple-tools-om-sso' ) ],
                    "two" => [ "label" => __( "Two", 'disciple-tools-om-sso' ) ],
                    "three" => [ "label" => __( "Three", 'disciple-tools-om-sso' ) ],
                    "four" => [ "label" => __( "Four", 'disciple-tools-om-sso' ) ],
                ],
                "tile" => "disciple_tools_om_sso",
                "type" => "multi_select",
                "hidden" => false,
             ...
             */
            $fields["disciple_tools_om_sso_keyselect"] = [
                'name' => "Key Select",
                'type' => 'key_select',
                "tile" => "disciple_tools_om_sso",
                'default' => [
                    'first'   => [
                        "label" => _x( 'First', 'Key Select Label', 'disciple-tools-om-sso' ),
                        "description" => _x( "First Key Description", "Training Status field description", 'disciple-tools-om-sso' ),
                        'color' => "#ff9800"
                    ],
                    'second'   => [
                        "label" => _x( 'Second', 'Key Select Label', 'disciple-tools-om-sso' ),
                        "description" => _x( "Second Key Description", "Training Status field description", 'disciple-tools-om-sso' ),
                        'color' => "#4CAF50"
                    ],
                    'third'   => [
                        "label" => _x( 'Third', 'Key Select Label', 'disciple-tools-om-sso' ),
                        "description" => _x( "Third Key Description", "Training Status field description", 'disciple-tools-om-sso' ),
                        'color' => "#366184"
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === "contacts" || $post_type === "om_sso" ) && $section === "disciple_tools_om_sso" ){
            /**
...
Disciple_Tools_OM_SSO_Tile::instance();
