...
/**
 * Class Disciple_Tools_OM_SSO_Magic_Link
 */
class Disciple_Tools_OM_SSO_Magic_Link extends DT_Magic_Url_Base {
    ...
    public $post_type = 'om_sso'; // @todo set the post type this magic link connects with.
    private $meta_key = '';
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === $this->post_type ){
            $tiles["dt_starters_magic_url"] = [
                "label" => __( "Magic Url", 'disciple-tools-om-sso' ),
    ...
    public function footer_javascript(){
        ...
        <script>
            ...
            let jsObject = [<?php echo json_encode([
                ...
                'parts' => $this->parts,
                'translations' => [
                    'add' => __( 'Add Magic', 'disciple-tools-om-sso' ),
                ],
            ]) ?>][0]
...
Disciple_Tools_OM_SSO_Magic_Link::instance();
